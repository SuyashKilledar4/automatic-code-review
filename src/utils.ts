...
export function anotherFunction(param1: any, param2: any){
...
export function longLineFunction() {
...
export function inconsistentSpacing ( a:number , b : number ) : number {
return a+b
}

export function unusedParams(a: number, b: number, c: number): number {
    return a + b
}

export function unreachableCode(): number {
    return 1
...
export function improperNaming(){
...
export function multipleIssues( a:any , b : any ){
    let unused = 123
    let result = a+b
